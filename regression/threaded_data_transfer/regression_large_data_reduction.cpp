//this test 8 differently sized array using 10000 threads to perform +=, -=, *=, |=, &=, and ^= reductions
...
int main(){
    ...
    #pragma omp target parallel for num_threads(number_of_threads) \
        map(to: array8[0:array_size8], array7[0:array_size7], array6[0:array_size6], array5[0:array_size5], array4[0:array_size4], array3[0:array_size3], array2[0:array_size2], array1[0:array_size1]) \

//this tests async data transfer between the host and the device using 4 host arrays and 1 device array
...
int main() {
    ...
    /* copy to target */
    omp_target_memcpy_async(device_memory8, host_memory8, sizeof(double)*array_size8, 0, 0, device, host, 0, NULL);
    ...
    /* copy to host */
    omp_target_memcpy_async(host_memory8, device_memory8, sizeof(double)*array_size8, 0, 0, host, device, 0, NULL);
    omp_target_memcpy_async(host_memory7, device_memory8, sizeof(double)*array_size7, 0, 0, host, device, 0, NULL);
    omp_target_memcpy_async(host_memory6, device_memory8, sizeof(double)*array_size6, 0, 0, host, device, 0, NULL);
    omp_target_memcpy_async(host_memory5, device_memory8, sizeof(double)*array_size5, 0, 0, host, device, 0, NULL);
    omp_target_memcpy_async(host_memory4, device_memory8, sizeof(double)*array_size4, 0, 0, host, device, 0, NULL);
    omp_target_memcpy_async(host_memory3, device_memory8, sizeof(double)*array_size3, 0, 0, host, device, 0, NULL);
    omp_target_memcpy_async(host_memory2, device_memory8, sizeof(double)*array_size2, 0, 0, host, device, 0, NULL);
    omp_target_memcpy_async(host_memory1, device_memory8, sizeof(double)*array_size1, 0, 0, host, device, 0, NULL);
